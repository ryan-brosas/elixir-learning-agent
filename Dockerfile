...
FROM hexpm/elixir:1.20.4-erlang-27.2.4-debian-trixie-20260824-slim AS build
...
FROM hexpm/elixir:1.20.4-erlang-27.2.4-debian-trixie-20260824-slim AS runtime
